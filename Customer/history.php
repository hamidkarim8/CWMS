            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">History Equipment Borrow</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                    ...
                    <div class="card-header">
                        <div class="card">
                            <div class="card-body">
                                <a type="button" class="btn btn-info btn-animation waves-effect waves-light" href='historyPrint.php' data-text="Print"><span>Print</span></a>
                                <br>
                                <br>
