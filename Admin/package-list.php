                                        ...
                                        <tbody>
                                            ...
                                            if ($result->num_rows > 0) {
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    $isFeatured = $row['isFeatured'] == 1 ? 'Yes' : 'No';
                                                    ...
                                                    <td >
                                                        <center>
                                                            ...
                                                            <a href='./Api/delete-package.php?id=$id' class='btn btn-danger btn-animation waves-effect waves-light data-text='Buang'>
                                                                Delete
                                                            </a>
                                                        </center>
                                                    </td>
                                                        ...
                                                        <div class='modal-dialog'>
                                                            <div class='modal-content'>
                                                                <div class='modal-header'>
                                                                    <h5 class='modal-title' id='myModalLabel'>Update Package Information</h5>
                                                                    <button type='button' class='btn-close' data-bs-dismiss='modal' aria-label='Close'> </button>
                                                                </div>
                                                                <form method='post' action='Api/update-package.php'>
                                                                    <div class='modal-body'>
                                                                        <div class='col-md-12 mt-4'>
                                                                            <label for='inputEmail4' class='form-label'>Package ID</label>
                                                                        ...
                                                                        <div class='col-md-12 mt-4'>
                                                                            <label for='inputEmail4' class='form-label'>Description (comma as separator)</label>
                                                                        ...
                                                                        <div class='col-md-12 mt-4'>
                                                                            <label for='inputEmail4' class='form-label'>Duration (hh:mm)</label>
                                                                            <input type='text' class='form-control' name='duration' pattern='^\d{1,2}:\d{2}$' value='$duration' required>
                                                                        </div>

                                                                        <div class='col-md-12 mt-4'>
                                                                        <label for='isFeatured' class='form-label'>Feature this package?</label>
                                                ...
                                                echo "
                                                <tr>
                                                <td colspan='9' align='center' style='color:red;' >No Package Available</td>
                                                </tr>";
                                            }
                                            ?>
                                        </tbody>
    ...
    <div id="myModal" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method='post' action='Api/add-package.php'>
                    <div class='modal-body'>
                        <h5 class='fs-15'>
                        ...
                        <div class='col-md-12 mt-4'>
                            <label for='inputDescription' class='form-label'>Description (comma as separator)</label>
                            <input type='text' class='form-control' name='description' placeholder='Description 1, Description 2, Description 3' required>
                        </div>

                        <div class='col-md-12 mt-4'>
                            <label for='inputEmail4' class='form-label'>Price (RM)</label>
                            <input type='number' class='form-control' name='price' required>
                        </div>

                        <div class='col-md-12 mt-4'>
                            <label for='duration' class='form-label'>Duration (hh:mm)</label>
                            <input type='text' class='form-control' name='duration' pattern='^\d{1,2}:\d{2}$' placeholder='hh:mm' title='Enter duration according to hh:mm format' required>
                        </div>
