            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Equipment List</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                    ...
                    <div class="card-header">
                        <div class="card">
                            <div class="card-body">
                                <button type="button" class="btn btn-success btn-animation waves-effect waves-light" data-text="Add Equipment" data-bs-toggle="modal" data-bs-target="#myModal"><span>Add Equipment</span></button>
                                <a type="button" class="btn btn-info btn-animation waves-effect waves-light" href='equipmentPrint.php' data-text="Print"><span>Print</span></a>
                                <br>
                                <br>
                                                ...
                                                echo "
                                                    ...
                                                    <td >
                                                        <center>
                                                            ...
                                                            <a href='./Api/removeEquipment.php?id=$id' class='btn btn-danger btn-animation waves-effect waves-light data-text='Buang'>
                                                                Remove
                                                            </a>
                                                        </center>
                                                    </td>
                                                        ...
                                                        <div class='modal-dialog'>
                                                            <div class='modal-content'>
                                                                <div class='modal-header'>
                                                                    <h5 class='modal-title' id='myModalLabel'>Update Equipment Information</h5>
                                                                    <button type='button' class='btn-close' data-bs-dismiss='modal' aria-label='Close'> </button>
                                                                </div>
                                                                <form method='post' action='Api/updateEquipment.php'>
                                                                    <div class='modal-body'>
                                                                        <div class='col-md-12'>
                                                                            <label for='inputEmail4' class='form-label'>Equipment No</label>
                                                                            <input type='text' class='form-control' value='$inventoryNo' disabled>
                                                                        </div>
                                                                        <div class='col-md-12'>
    ...
    <div id="myModal" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method='post' action='Api/addEquipment.php'>
                    <div class='modal-body'>
                        <h5 class='fs-15'>
