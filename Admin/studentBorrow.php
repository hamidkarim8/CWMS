...
<script>
    function updateQuantityLimit(selectElement) {
        ...
        document.querySelector('input[name="quantity"]').setAttribute('max', quantityLimit);
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Borrow Equipment </h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                    ...
                    <div class="card-header">
                        <div class="card">
                            <div class="card-body">
                                <form method='post' action='Api/borrowBook.php'>
                                    <div class='modal-body'>
                                        <div class='mb-3'>
                                            <label for='inputEmail4' class='form-label'>Student Name</label>
                                            <input type='email' class='form-control' name='email' value='<?php echo $nama;?>' disabled>
                                        </div>
                                        <div class='mb-3'>
                                            <label for='inputEmail4' class='form-label'>Student Matriculation Card </label>
                                            <input type='text' class='form-control' name='nama' value='<?php echo $noMatrik;?>' disabled>
                                        </div>
                                        <div class='mb-3'>
                                            <label for='inputEmail4' class='form-label'>Student Email </label>
                                            <input type='text' class='form-control' name='nama' value='<?php echo $email;?>' disabled>
                                        </div>

                                        <div class='mb-3'>
                                            <label for='inputEmail4' class='form-label'>Equipment</label>
                                            <select class='form-select mb-3' aria-label='Default select example' name='equipment' required onclick='updateQuantityLimit(this)'>
                                                <?php 
                                                    ...
                                                    if ($result->num_rows > 0) {
                                                        while ($row = $result->fetch_assoc()) {
                                                            ...
                                                            $borrow = $row['borrow'];
                                                            $idQ = $row['id'];
                                                            $limit=$quantity-$borrow;
                                                            if($limit>0){
                                                                echo "<option value='$idQ' data-quantity='$limit'>$item ($inventoryNo) Available $limit</option>";
                                                            }
                                                        }
                                                    }
                                                ?>
                                        ...
                                        <div class='mb-3'>
                                            <label for='inputEmail4' class='form-label'>Borrow Date</label>
                                            <input type='date' class='form-control' value="<?php echo date('Y-m-d'); ?>" disabled name='borrow' required>
                                        </div>
                                        <div class='mb-3'>
                                            <label for='inputEmail4' class='form-label'>Return Date</label>
                                            <input type='date' class='form-control' name='return' required>
                                        </div>
                                        <input type='hidden' value='<?php echo $id;?>' name='id' />
                                    </div>
                                    <br>
                                        <center><button class='btn btn-primary' type='submit'>Borrow</button></center>
                                </form>
                            </div>
                        </div> <!-- end col -->
                    </div>
