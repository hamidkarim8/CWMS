                    ...
                    <div class="card-header">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a type="button" class="btn btn-info btn-animation waves-effect waves-light" href='studentListPrint.php' data-text="Print"><span>Print</span></a>
                                <br>
                                <br>
                                        ...
                                        if ($result->num_rows > 0) {
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo "
                                                    ...
                                                    <td >
                                                        <center>
                                                            <button type='button' class='btn btn-warning btn-animation waves-effect waves-light data-text='Update' data-bs-toggle='modal' data-bs-target='#link$modal'>
                                                                Link NFC
                                                            </button>
                                                            ...
                                                            <a href='./studentBorrow.php?id=$id' class='btn btn-info btn-animation waves-effect waves-light data-text='Buang'>
                                                                Equipment Borrow
                                                            </a>
                                                        </center>
                                                    </td>
                                                            ...
                                                            <div class='modal-content'>
                                                                ...
                                                                <form method='post' action='Api/updateStudent.php'>
                                                                    <div class='modal-body'>
                                                                        ...
                                                                        <div class='col-md-12'>
                                                                            <label for='inputEmail4' class='form-label'>Matriculation No.</label>
                                                                            <input type='text' class='form-control' name='noMatrik' value='$noMatrik' required>
                                                                        </div>
                                                                    
                                                                        <div class='col-md-12'>
                                                                            <label for='inputEmail4' class='form-label'>No. Phone</label>
                                                ...
                                                ";
                                                echo "
                                                    <div id='link$modal' class='modal fade' tabindex='-1' aria-labelledby='myModalLabel' aria-hidden='true' style='display: none;'>
                                                        <div class='modal-dialog'>
                                                        <div class='modal-content'>
                                                            <div class='modal-header'>
                                                                    <h5 class='modal-title' id='myModalLabel'>Link NFC Pelajar</h5>
                                                                    <button type='button' class='btn-close' data-bs-dismiss='modal' aria-label='Close'> </button>
                                                                </div>
                                                                    ...
                                                                    <div class='modal-body'>
                                                                        ...
                                                                        <div class='col-md-12'>
                                                                            <label for='inputEmail4' class='form-label'>Link NFC Pelajar</label>
                                                                            <input type='text' class='form-control' name='email' value='http://localhost/ssems/Staff/studentBorrowNfc.php?id=$id' disabled>
                                                                        </div>
                                            ...
                                            echo "
                                                <tr>
                                                <td colspan='9' align='center'>No Student</td>
                                                </tr>";
                                        }
                                        ?>
                                    </tbody>
            ...
            <div class="modal-content">
                ...
                <form method='post' action='Api/addStudent.php'>
                    <div class='modal-body'>
                        ...
                        <div class='col-md-12'>
                            <label for='inputEmail4' class='form-label'>Matriculation No.</label>
                            <input type='text' class='form-control' name='noMatrik' required>
                        </div>
