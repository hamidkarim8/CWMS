            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <div class="card-header">
                        <div class="card">
                            <div class="card-body">
                                <button type="button" class="btn btn-success btn-animation waves-effect waves-light" data-text="Add Staff" data-bs-toggle="modal" data-bs-target="#myModal"><span>Add Staff</span></button>
                                <br>
                                <br>
                                <table class="table table-primary table-striped align-middle table-nowrap mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        $query = "SELECT user.email, user.password, profile.* FROM user JOIN profile ON profile.user_id=user.id WHERE role='Staff';";
                                        ...
                                        if ($result->num_rows > 0) {
                                                ...
                                                echo "
                                                    ...
                                                    <td >
                                                        <center>
                                                            ...
                                                            <a href='./Api/removeStaff.php?userId=$user_id' class='btn btn-danger btn-animation waves-effect waves-light data-text='Buang'>
                                                                Remove Staff
                                                            </a>
                                                        </center>
                                                    </td>
                                                    ...
                                                    <div id='view2$modal' class='modal fade' tabindex='-1' aria-labelledby='myModalLabel' aria-hidden='true' style='display: none;'>
                                                        <div class='modal-dialog'>
                                                            <div class='modal-content'>
                                                                ...
                                                                <form method='post' action='Api/updateStaff.php'>
                                                                    <div class='modal-body'>
                                                                        ...
                                                                        <div class='col-md-12'>
                                                                            <label for='inputEmail4' class='form-label'>I/C</label>
                                                                            <input type='text' class='form-control' name='noKp' required value='$noKp'>
                                                                        </div>
                                            ...
                                            echo "
                                                <tr>
                                                <td colspan='9' align='center'>No Staff</td>
                                                </tr>";
                                        }
                                        ?>
                                    </tbody>
    ...
    <div id="myModal" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method='post' action='Api/addStaff.php'>
                    <div class='modal-body'>
                        <h5 class='fs-15'>
                            <span style='color:red;'>*</span>Fill All Information <br>
                            <span style='color:red;'>*</span>First Password Same With I/C Number<br>
                        </h5>
                        <div class='col-md-12'>
                            <label for='inputEmail4' class='form-label'>Name</label>
